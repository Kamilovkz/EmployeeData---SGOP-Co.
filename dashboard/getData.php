<?php
    ...
    if($action == "allemployee"){    
        ...
        if($queryNumcount >= 1 ){
            ...
            echo '<li class="emp_item"> No employee was found in the database </li>';
        }
    }
    ...
    if($action == "currentemployees"){
        ...
        $sortBy = $_POST['sortBy'];
        if(!empty($keywords)){
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND `status` = 'Active'";
        } else {
    ...
    if($action == "pastemployees"){
        ...
        $sortBy = $_POST['sortBy'];
        if(!empty($keywords)){
            $whereSQL = "WHERE (`middle_name` LIKE '%".$keywords."%' OR `last_name` LIKE '%".$keywords."%' OR `first_name` LIKE '%".$keywords."%') AND `status` = 'Inactive'";
        } else {
