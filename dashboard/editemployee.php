<?php 
	...
	include("../inc/db_connect.php");
		...
		$query .= "UPDATE sharp_emp SET employee_id = '$employee_id', first_name = '$firstname', middle_name = '$middlename', last_name = '$lastname', phone = '$phone', id_type = '$idtype', id_number = '$idnumber', residence_address = '$resaddress', residence_direction = '$resdirection',  next_of_kin = '$fullname', relationship = '$relationship', phone_of_kin = '$kinphone', kin_residence = '$kinresaddress', kin_residence_direction = '$kinresdirection', date_employed = '$dateemployed', job_type = '$jobtype', status = '$empstatus' WHERE id = '$record_id' ; ";
