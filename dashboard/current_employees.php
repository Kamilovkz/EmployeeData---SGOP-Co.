<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM sharp_emp WHERE status = 'Active'");
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">Active employees</div>
				<div class="top-bar">
					<div class="top-item">
					...
					<div class="top-item">
						<form id="empFilter" method="post" action="">
							<br>
							<button class="nav-item"><a href="../dashboard/add_employee.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>Add employee</a></button>
							<button class="nav-item"><a href="../dashboard/add_user.php"><span class="nav-icon"><i class="fa fa-user"></i></span>Add admin</a></button>
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM sharp_emp WHERE status = 'Active' ORDER BY id ASC");
				...
				<ul class="emp_list">
					<li class="emp_list_head">
						...
						<div class="emp_item_head">Nickname</div>
					...
					<div id="displayempList">
						<?php
							if($getempcount >= 1 ){
								...
								echo '<li class="emp_item"> There is not active employees </li>';
							}
						?>
					</div>
				</ul>
